...
print_tuple(tp2);
aq:
printf("enter 1 to find tuple forms of transpose 2 to print tupel form of sum 3 to exit");
scanf("%d", &x);
switch (x)
{
case 1:
...
printf("did you wish to continue y or n");
scanf("%c", &y);
if (y ='y')
{
    goto aq;
...
for (int j = 1; j <= k - i; j++)
{
/* If the row number of the current element is greater than the row number of the next
element*/
if (c[j][0] > c[j + 1][0])
{
// Swap the elements
...
{
// If the row number of the current element of tuple 1 is equal to the row number of the
//current element of tuple 2
if (a[i][0] == b[j][0])
{
// If the column number of the current element of tuple 1 is equal to the column number
//of the current element of tuple 2
if (a[i][1] == b[j][1])
{
...
// If the column number of the current element of tuple 1 is less than the column number
//of the current element of tuple 2
else if (a[i][1] < b[j][1])
{
...
// If the column number of the current element of tuple 1 is greater than the column
//number of the current element of tuple 2
else
{
...
// If the row number of the current element of tuple 1 is less than the row number of the
//current element of tuple 2
else if (a[i][0] < b[j][0])
{
// Copy the element of tuple 1 to the sum tuple
...
// If the row number of the current element of tuple 1 is greater than the row number of the
//current element of tuple 2
else
{
// Copy the element of tuple 2 to the sum tuple
